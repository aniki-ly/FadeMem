...
from pipeline.streaming_training import _CacheDict
...
class SelfForcingTrainingPipeline:
    def __init__(self,
        ...
        if DEBUG:
            print(f"[KV policy] local_attn_size={self.local_attn_size} slice_last_frames={slice_last_frames} fademem={self.fademem_enabled} num_training_frames={num_training_frames} -> kv_frames={kv_frames}")
