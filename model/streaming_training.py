    ...
    def _clear_cache_gradients(self):
        ...
        if hasattr(self.inference_pipeline, 'kv_cache1') and self.inference_pipeline.kv_cache1 is not None:
            for cache_block in self.inference_pipeline.kv_cache1:
                ...
                if 'fademem_k' in cache_block and cache_block['fademem_k'].requires_grad:
                    cache_block['fademem_k'] = cache_block['fademem_k'].detach()
                if 'fademem_v' in cache_block and cache_block['fademem_v'].requires_grad:
                    cache_block['fademem_v'] = cache_block['fademem_v'].detach()
