...
class WanT2VCrossAttention(WanSelfAttention):
    ...
    def forward(self, x, context, context_lens, crossattn_cache=None):
        ...
        # For stateful cached generation, avoid storing graph-carrying cross-attn
        # projections in the persistent cache during grad-enabled passes.
        # We still keep cache reuse for no-grad denoising / recache passes.
        if crossattn_cache is not None and (not torch.is_grad_enabled()):
